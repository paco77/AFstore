                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0 mr-3">
                                                    <img v-if="item.product_almacen?.imagen" @click="viewImage('/storage/' + item.product_almacen.imagen, item.product_almacen.nombre)" class="h-10 w-10 rounded-full object-cover border border-gray-200 cursor-pointer hover:opacity-75 transition" :src="'/storage/' + item.product_almacen.imagen" alt="" />
