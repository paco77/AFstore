                        ...
                        <table class="min-w-full divide-y divide-gray-200 border-separate border-spacing-0">
                            <thead class="bg-gray-100 sticky top-0 z-10">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider bg-gray-100 border-b">Código</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <tr v-for="(item, index) in form.productos" :key="index" class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-mono text-indigo-600 font-bold">
                                        {{ item.clave }}
                                    </td>
